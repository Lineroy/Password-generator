...
sleep(1)
print("\nNow I will ask you a couple of questions about functionality. Answer them and you will get your happiness! :)")
sleep(1)


symbols = input('\nAre you want add to list of letters and numbers addition symbols in type "!", "?", "$" etc. (Y, N): ')
if symbols.upper() == "Y":
    addition = r"!@~`@#№;$%^:&?*|\/<>"
...
while True:
    try:
        ...
        print(Fore.LIGHTRED_EX + "Try again write command!")
...
file_write = input("\nCan I write your passwords to a file? (Y, N): ")
...
if file_write.upper().startswith("Y"):
    ...
    while True:
        format_of_file = input("Write format of file, if you want leave format by standard(.txt) press 'Enter': ")
        if format_of_file == "":
            format_of_file = "txt"
    ...
    file.write(f"\n\nThe file was created: {str(datetime.now())[:19]}")

    print(Fore.LIGHTGREEN_EX + "The password file was created successfully.")
    file.close()
